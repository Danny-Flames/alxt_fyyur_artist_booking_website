...
# Instantiating migrate as this is what will let us initialize(init), downgrade and upgrade migrations
...
def create_venue_submission():
    ...
    try:
        payload = request.get_json()['new_venue']
        new_venue = Venue(name=payload['name'], city=payload['city'], state=payload['state'], phone=payload['phone'], genres=payload['genres'], facebook_link=payload['facebook_url'], image_link=payload['image_url'], website_link=payload['website_url'], talent_search=payload['talent_search'], description=payload['description'])
